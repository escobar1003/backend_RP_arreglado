...
router.get('/api/puntos-reciclaje', [
  () => import('#controllers/puntos_reciclajes_controller'),
  'index',
])
router.get('/api/puntos-reciclaje/:id', [
  () => import('#controllers/puntos_reciclajes_controller'),
  'show',
])
...
router
  .group(() => {
    ...
    router.post('/registrarse', [
      () => import('#controllers/auth/registros_controller'),
      'registrarse',
    ])
    router.post('/recuperar-password/solicitar', [
      () => import('#controllers/auth/recuperar_passwords_controller'),
      'solicitarCodigo',
    ])
...
router
  .group(() => {
    ...
    router.put('/admins/:id', [
      () => import('#controllers/admin/administradores_controller'),
      'update',
    ])
    ...
    router.get('/encargados/:id', [
      () => import('#controllers/admin/encargados_controller'),
      'show',
    ])
    router.post('/encargados', [() => import('#controllers/admin/encargados_controller'), 'store'])
    router.put('/encargados/:id', [
      () => import('#controllers/admin/encargados_controller'),
      'update',
    ])
    router.delete('/encargados/:id', [
      () => import('#controllers/admin/encargados_controller'),
      'destroy',
    ])
    router.put('/encargados/:id/asignar-punto', [
      () => import('#controllers/admin/encargados_controller'),
      'asignarPunto',
    ])
    ...
    router.delete('/usuarios/:id', [
      () => import('#controllers/admin/usuarios_controller'),
      'destroy',
    ])
    ...
    router.delete('/aliados/:id', [
      () => import('#controllers/admin/aliados_controller'),
      'destroy',
    ])
    router.get('/aliados/:id/materiales', [
      () => import('#controllers/admin/aliados_controller'),
      'materiales',
    ])
    router.put('/aliados/:id/materiales', [
      () => import('#controllers/admin/aliados_controller'),
    ...
    router.get('/materiales/:id', [
      () => import('#controllers/admin/materiales_controller'),
      'show',
    ])
    ...
    router.get('/recompensas/:id', [
      () => import('#controllers/admin/recompensas_controller'),
      'show',
    ])
    ...
    // Estados Materiales
    // Puntos (ajuste)
    router.post('/usuarios/:idUsuario/ajustar-puntos', [
      () => import('#controllers/admin/puntos_controller'),
      'ajustarPuntos',
    ])

    // Estados Materiales
    router.get('/estados-materiales', [
      () => import('#controllers/admin/estados_materiales_controller'),
      'index',
    ])
    router.get('/estados-materiales/:id', [
      () => import('#controllers/admin/estados_materiales_controller'),
      'show',
    ])
    router.post('/estados-materiales', [
      () => import('#controllers/admin/estados_materiales_controller'),
      'store',
    ])
    router.put('/estados-materiales/:id', [
      () => import('#controllers/admin/estados_materiales_controller'),
      'update',
    ])
    router.delete('/estados-materiales/:id', [
      () => import('#controllers/admin/estados_materiales_controller'),
      'destroy',
    ])

    // Estados Puntos
    router.get('/estados-puntos', [
      () => import('#controllers/admin/estados_puntos_controller'),
      'index',
    ])
    router.get('/estados-puntos/:id', [
      () => import('#controllers/admin/estados_puntos_controller'),
      'show',
    ])
    router.post('/estados-puntos', [
      () => import('#controllers/admin/estados_puntos_controller'),
      'store',
    ])
    router.put('/estados-puntos/:id', [
      () => import('#controllers/admin/estados_puntos_controller'),
      'update',
    ])
    router.delete('/estados-puntos/:id', [
      () => import('#controllers/admin/estados_puntos_controller'),
      'destroy',
    ])

    // Estados Entregas
    router.get('/estados-entregas', [
      () => import('#controllers/admin/estados_entregas_controller'),
      'index',
    ])
    router.get('/estados-entregas/:id', [
      () => import('#controllers/admin/estados_entregas_controller'),
      'show',
    ])
    router.post('/estados-entregas', [
      () => import('#controllers/admin/estados_entregas_controller'),
      'store',
    ])
    router.put('/estados-entregas/:id', [
      () => import('#controllers/admin/estados_entregas_controller'),
      'update',
    ])
    router.delete('/estados-entregas/:id', [
      () => import('#controllers/admin/estados_entregas_controller'),
      'destroy',
    ])
    ...
    router.put('/entregas/:id/estado', [
      () => import('#controllers/admin/entregas_controller'),
      'actualizarEstado',
    ])

    // Estadísticas para dashboard
    router.get('/estadisticas', [
      () => import('#controllers/admin/estadisticas_controller'),
      'index',
    ])

    // Estados Aliados
    router.get('/estados-aliados', [
      () => import('#controllers/admin/estados_aliados_controller'),
      'index',
    ])
    router.get('/estados-aliados/:id', [
      () => import('#controllers/admin/estados_aliados_controller'),
      'show',
    ])
    router.post('/estados-aliados', [
      () => import('#controllers/admin/estados_aliados_controller'),
      'store',
    ])
    router.put('/estados-aliados/:id', [
      () => import('#controllers/admin/estados_aliados_controller'),
      'update',
    ])
    router.delete('/estados-aliados/:id', [
      () => import('#controllers/admin/estados_aliados_controller'),
      'destroy',
    ])

    // Estados Canjes
    router.get('/estados-canjes', [
      () => import('#controllers/admin/estados_canjes_controller'),
      'index',
    ])
    router.get('/estados-canjes/:id', [
      () => import('#controllers/admin/estados_canjes_controller'),
      'show',
    ])
    router.post('/estados-canjes', [
      () => import('#controllers/admin/estados_canjes_controller'),
      'store',
    ])
    router.put('/estados-canjes/:id', [
      () => import('#controllers/admin/estados_canjes_controller'),
      'update',
    ])
    router.delete('/estados-canjes/:id', [
      () => import('#controllers/admin/estados_canjes_controller'),
      'destroy',
    ])
    ...
    router.post('/aliados/:id/punto', [
      () => import('#controllers/admin/puntos_reciclajes_controller'),
      'store',
    ])
    router.put('/aliados/:id/punto', [
      () => import('#controllers/admin/puntos_reciclajes_controller'),
      'update',
    ])
  })
...
router
  .group(() => {
    ...
    router.put('/perfil/cambiar-password', [
      () => import('#controllers/usuario/perfil_controller'),
      'cambiarPassword',
    ])
    // Foto de perfil
    router.post('/perfil/foto', [
      () => import('#controllers/usuario/foto_perfils_controller'),
      'store',
    ])
    // Entregas
    ...
    router.get('/puntos/historial', [
      () => import('#controllers/usuario/puntos_controller'),
      'historial',
    ])
    ...
    router.get('/recompensas', [
      () => import('#controllers/usuario/recompensas_controller'),
      'index',
    ])

    // Aliados
    router.get('/aliados', [
      () => import('#controllers/usuario/aliados_usuarios_controller'),
      'index',
    ])
    // Reservas (app móvil - usuario)
    router.get('/reservas', [
      () => import('#controllers/usuario/reservas_usuario_controller'),
      'index',
    ])
    ...
    router.put('/reservas/:id/cancelar', [
      () => import('#controllers/usuario/reservas_usuario_controller'),
      'cancelar',
    ...
    router.post('/reservas/:id/imagenes', [
      () => import('#controllers/usuario/reserva_imagenes_controller'),
      'store',
    ])
    router.get('/reservas/:id/imagenes', [
      () => import('#controllers/usuario/reserva_imagenes_controller'),
      'index',
    ])
    ...
    router.get('/notificaciones', [
      () => import('#controllers/usuario/notificaciones_usuario_controller'),
      'index',
    ])
  ...
  .prefix('/api/usuario')
  .use([middleware.auth(), middleware.verificar_rol(['usuario'])])
...
router
  .group(() => {
    ...
    router.put('/perfil', [
      () => import('#controllers/aliado/perfil_aliado_controller'),
      'actualizar',
    ])
    router.post('/perfil/puntos', [
      () => import('#controllers/aliado/perfil_aliado_controller'),
      'agregarPunto',
    ])
    router.put('/perfil/puntos/:id', [
      () => import('#controllers/aliado/perfil_aliado_controller'),
      'actualizarPunto',
    ])
    ...
    // Entregas del aliado
    router.get('/entregas', [
      () => import('#controllers/aliado/entregas_aliado_controller'),
      'index',
    ])
    ...
    router.get('/clasificaciones', [
      () => import('#controllers/aliado/clasificacion_controller'),
      'index',
    ])
  ...
  .prefix('/api/aliado')
  .use([middleware.auth(), middleware.verificar_rol(['aliado'])])

// ENCARGADO
router
  .group(() => {
    router.get('/reservas', [
      () => import('#controllers/encargado/reservas_encargado_controller'),
      'index',
    ])
    router.get('/reservas/:id', [
      () => import('#controllers/encargado/reservas_encargado_controller'),
    ...
    router.get('/materiales', [
      () => import('#controllers/encargado/materiales_controller'),
      'index',
    ])

    // Notificaciones
    router.get('/notificaciones', [
      () => import('#controllers/encargado/notificaciones_controller'),
      'index',
    ])
    router.put('/notificaciones/leer-todas', [
      () => import('#controllers/encargado/notificaciones_controller'),
    ...
    // Perfil
    router.get('/perfil', [
      () => import('#controllers/encargado/perfil_encargado_controller'),
      'mostrar',
    ])
    router.put('/perfil', [
      () => import('#controllers/encargado/perfil_encargado_controller'),
    ...
    router.get('/entregas/:id', [
      () => import('#controllers/encargado/entregas_controller'),
      'show',
    ])
    ...
    router.get('/entregas/:id/comprobante', [
      () => import('#controllers/encargado/entregas_controller'),
      'comprobante',
    ])
    ...
    //canjes
    router.get('/canjes', [
      () => import('#controllers/encargado/canjes_encargado_controller'),
      'index',
    ])
    router.get('/canjes/:id', [
      () => import('#controllers/encargado/canjes_encargado_controller'),
      'show',
    ])
    router.post('/canjes', [
    ...
    router.put('/canjes/:id/estado', [
      () => import('#controllers/encargado/canjes_encargado_controller'),
      'actualizarEstado',
    ])
    router.put('/canjes/:id/validar', [
      () => import('#controllers/encargado/canjes_encargado_controller'),
      'validar',
    ])
    ...
    // Recompensas
    router.get('/recompensas', [
      () => import('#controllers/encargado/recompensas_controller'),
      'index',
    ])
    router.post('/recompensas', [
      () => import('#controllers/encargado/recompensas_controller'),
